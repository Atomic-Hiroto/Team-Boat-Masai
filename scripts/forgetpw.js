...
// this is for porget pw
 const forgetPasswordForm = document.querySelector(".inputs");
 const forgetPasswordEmailInput = forgetPasswordForm.querySelector("input");
 const forgetPasswordButton = forgetPasswordForm.querySelector("button");
