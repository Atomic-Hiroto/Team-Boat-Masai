//  this is for header
 ...
 window.onclick = function(event) {
  ...
  // this is for signup
  const createAccountForm = document.querySelector(".inputs");
  const firstNameInput = createAccountForm.querySelectorAll("input")[0];
  const lastNameInput = createAccountForm.querySelectorAll("input")[1];
  const emailInput = createAccountForm.querySelectorAll("input")[2];
  const passwordInput = createAccountForm.querySelectorAll("input")[3];
  const createAccountButton = createAccountForm.querySelector("button");
